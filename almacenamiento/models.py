...
class Ubicacion(models.Model):
    ...
    encargado = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True,
                                 help_text="Usuario encargado de la ubicación")
    ...
    def __str__(self):
        encargado = f" - {self.encargado.get_full_name() or self.encargado.username}" if self.encargado else ""
...
class Stock(models.Model):
    ...
    # Referencia a mercadería del otro módulo
    mercaderia = models.ForeignKey('mercaderias.Mercaderia', on_delete=models.CASCADE, related_name='stocks')
